...
If a patient has overpaid or you want to add a balance they can draw down later (a refund kept on account, for example), use **Add credit** instead of Take payment -- that adds to their account credit rather than applying to a specific invoice.
